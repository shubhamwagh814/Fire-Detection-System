...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "ikartikjadhav@gmail.com" # recipients mail
    ...
    try:
        with smtplib.SMTP_SSL("smtp.gmail.com", 465) as server:
            server.login('firealertsystem2023@gmail.com', 'fkasflxuhrewxmqw') # Senders mail ID and password
            server.sendmail('ikartikjadhav@gmail.com', recipientmail, message) # recipients mail with mail message
